/**
 * Contenido del detalle de un caso jurídico (Server Component)
 * — reutilizable desde la página full y desde el modal intercept.
 */
...
import { GestionJuridicoButton } from '../[id]/gestion-juridico-button';
import { SubirDocumentoJuridicoButton } from '../[id]/subir-documento-juridico-button';

export async function JuridicoDetalleContent({ id }: { id: string }) {
  ...
  // Si el caso ya no está en flujo jurídico, mostramos panel informativo
  // (mismo comportamiento que tenía la página full antes de extraer).
