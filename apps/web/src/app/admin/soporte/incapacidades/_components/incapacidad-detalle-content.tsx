/**
 * Contenido del detalle de incapacidad (Server Component) — reutilizable
 * tanto desde la página full (`[id]/page.tsx`) como desde el modal
 * intercept (`@modal/(.)[id]/page.tsx`). Sin breadcrumb / back-link;
 * el wrapper decide si lo agrega.
 */

import Link from 'next/link';
import { notFound } from 'next/navigation';
import { HeartPulse, Paperclip, Download, LifeBuoy, Building2, Clock3, FileX } from 'lucide-react';
...
import { GestionSoporteIncapButton } from '../[id]/gestion-soporte-button';
import { AnularIncapacidadButton } from '../[id]/anular-button';
import { SubirDocumentoSoporteButton } from '../[id]/subir-documento-button';

export async function IncapacidadDetalleContent({ id }: { id: string }) {
