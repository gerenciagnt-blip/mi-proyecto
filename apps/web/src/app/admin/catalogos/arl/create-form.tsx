...
import { createArlAction, type ActionState } from './actions';

export function CreateArlForm() {
  const [state, action, pending] = useActionState<ActionState, FormData>(createArlAction, {});
